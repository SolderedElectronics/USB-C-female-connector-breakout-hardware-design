# USB-C female connector breakout Hardware Design

## About the Product

| ![USB-C female connector breakout Image](https://solde.red/333011/image) |
| :----------------------------------------------------------: |
...
This repository contains all design files for USB-C female connector breakout, organized as follows:
